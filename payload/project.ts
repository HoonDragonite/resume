  ...
  list: [
    {
      ...
      descriptions: [
        ...
        },
        {
          ...
          weight: 'MEDIUM',
          descriptions: [
            { content: 'WPF MVVM 패턴을 적용하여 메뉴, 탭 기반 프로그램 UI/UX 개발' },
          ],
        },
      ],
    },
    {
      ...
      where: '한라엔컴',
      descriptions: [
        { content: '기존 Spring MVC 프로젝트에 기간별 생산자료 집계 화면 개발' }
      ],
    },
    {
      title: '인사평가 시스템 개발',
    ...
    },
    {
      ...
      where: '개인 프로젝트',
      descriptions: [
        { content: '교내 열람실 좌석 정보를 크롤링하여 Java 기반의 안드로이드 앱 제작 후 배포(설치수 100++)'}
      ],
    },
  ],
};
